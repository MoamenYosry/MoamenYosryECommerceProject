...
public class Def1_Register {
    ...
    public void user_enter_first_name(){
        register.firstName().sendKeys("Moamen");

        register.lastName().sendKeys("Yosry");
        ...
        register.email().sendKeys("moamenyosry95@gmail.com");

        register.companyName().sendKeys("Mine");
